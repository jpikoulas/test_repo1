...
* Follow this stanza name with several Role-to-Group(s) mappings as defined
  below.
* Note: Importing groups for the same user from different strategies is not supported.
...
* REQUIRED
* Full path including the certificate name of the IDP (Identity Provider)
* Assertions from the IDP will be verified using this certificate.
...
attributeQuerySoapPassword = <string>
* REQUIRED
